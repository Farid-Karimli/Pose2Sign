...
def load_images_from_folder(folder):
    ...
    for filename in sorted_files:
        ...
        if ext in valid_extensions:
            ...
            images.append(img)
        elif ext in video_extensions: # If the provided file is a video, take its first frame
            ...
            while True:
                ...
                break  # Only take the first frame of the video
            cap.release()
...
def main():
    ...
    # Set requires_grad for trainable parameters BEFORE wrapping with DeepSpeed
    ...
    # Create DeepSpeed wrapper AFTER setting up optimizer
    if accelerator.distributed_type == DistributedType.DEEPSPEED:
        ds_wrapper = DeepSpeedWrapperModel(
            unet=unet,
            controlnext=controlnext
        )
        # Don't reassign unet and controlnext here - use the wrapper directly
    ...
    if accelerator.distributed_type == DistributedType.DEEPSPEED:
        ...
        # Extract wrapped models for use in training
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(controlnext, unet):
                ...
                with accelerator.autocast():
                    ...
                    # Turning the real video pixels to latents
                    ...
                    # Turning the conditioning (pose) video to latents    
                        ...
                        with accelerator.autocast():
                            for i, (val_ref_frame, val_control_frames) in enumerate(validation_pairs):
                                ...
                                video_frames = pipeline(
                                    ...
                                    frames_per_batch=args.sample_n_frames, #args.sample_n_frames,
                                    decode_chunk_size=4,
